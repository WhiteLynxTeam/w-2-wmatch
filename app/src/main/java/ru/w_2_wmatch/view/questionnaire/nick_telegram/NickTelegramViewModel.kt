...
class NickTelegramViewModel(private val saveBrandPrefUseCase: SaveBrandPrefUseCase): ViewModel() {
    ...
    class Factory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            if (modelClass.isAssignableFrom(NickTelegramViewModel::class.java)) {
                return NickTelegramViewModel(
